<%-- 
    Document   : ListLevelIncharge
    Created on : Aug 26, 2019, 7:40:06 PM
    Author     : Lenovo
--%>
...
%>
<h1><legend>Level Incharge Details</legend> </h1>
     
<fieldset>
    <div>
        <form>
            <div><table><td>Enter Level Incharge Name </td><td></td><td><input type="text" name="searchValue"></td><td><input type="submit" name="Action" value="Search"></td></table></div>
        </form>
     ...
     <%
        String sqlQuery="";
        String tec="LevelIncharge";
        try{
            
        if(request.getParameter("Action").equalsIgnoreCase("Search")){
             String searchValue=request.getParameter("searchValue");
             sqlQuery="select * from teacher where firstname like '%"+searchValue+"%'"; 
            }else{
    ...
    {
    out.print("<tr><td>"+i+"</td><td>"+db.rs.getString(3)+"</td><td>"+db.rs.getString(4)+"</td><td>"+db.rs.getString(5)+"</td><td>"+db.rs.getString(6)+"</td>" 
         + "<td>"+db.rs.getString(7)+"</td><td>"+db.rs.getString(8)+
            "</td><td>"+db.rs.getString(9)+"</td><td>"+db.rs.getString(10)+"</td><td>"+db.rs.getString(11)+"</td><td>"+db.rs.getString(12)+"</td><td>"
            +db.rs.getString(13)+"</td><td></tr>");
    }
