    ...
    <body onload="">
        <div id="wrapper">
           ...
           <%
            ...
            String type="",firstname = "",  lastname = "", Qualification="", Email="",username="",  dob = "", gender = "", status = "", Remarks = "", address = "",  tchId = "",user="", contact="";
             try {
                ...
                if (request.getParameter("Action").equalsIgnoreCase("save")) {
                    try {
                        ...
                        sql = "insert into admin VALUES(null,'" + user + "','"  + firstname + "','"+ lastname +  "','" + Qualification + "','" + Email + "','" + username + "','" + dob + "','" + gender + "','" + status + "','" + Remarks + "','" + address  +"','"+contact+"')";
                        //out.print(sql);
                    ...
                    try {
                        ...
                        sql = "update admin  set user='" + user + "',firstname='" + firstname + "',lastname='" + lastname + "',email='" + Email + "',username='" + username +
                                 "',dob='" + dob +"',gender='" + gender + "',status='" + status + "',remarks='" + Remarks + "',address='" + address +  "',contact='"+contact+"' where id='" + tchId + "'";
                        //out.print(sql);
                        int row = db.st.executeUpdate(sql);
                        out.print("<script>alert('Updated');window.location.assign(\""+request.getContextPath()+"/page/listAdmin.jsp \");</script>");
                    } catch (Exception e) {
                        out.print(e.getMessage());
                    }
        ...
        <form method="get">
            <input type="hidden" name="tchId" value="<%=tchId%>"/>
               ...
               Qualification : <input size="30" type="text" name="qualification" value="<%=Qualification%>" style="margin-left:15%;margin-top:30px;"><br/>
                ...
                Address :<input size="30" type="text" name="address" value="<%=address%>"style="margin-left:24%"><br/>
